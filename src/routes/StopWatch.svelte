...
>
    <svg width="100%" height="100%" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
        ...
        <path fill="#4a5058" d="M68.324 17.126v11.04h-8.71v-11.04z"/>
        <path d="M55.19 6.84c0-.7.39-1.35 1.02-1.66C57.3 4.63 59.54 4 64 4s6.7.63 7.8 1.18c.63.31 1.02.96 1.02 1.66v9.01c0 1.35-1.26 1.54-2.28 1.54l-13.6-.16c-1.57-.22-1.73-.36-1.73-1.38V6.84z"
              fill="#6a7178"/>
        <ellipse cx="64" cy="16.56" rx="8.65" ry="1.56" fill="#4a5058"/>
        <path fill="#4a5058" d="M108.04 36.527l-6.556 6.555l-5.176-5.176l6.555-6.555z"/>
        <path d="M106.34 22.61a1.54 1.54 0 0 1 1.59-.38c.98.33 2.68 1.28 5.33 3.93s3.6 4.35 3.93 5.33c.19.56.03 1.17-.38 1.59l-5.35 5.35c-.8.8-1.66.17-2.27-.44l-7.99-8.18c-.8-1.06-.82-1.24-.21-1.85l5.35-5.35z"
              fill="#6a7178"/>
        <ellipse transform="rotate(-45.001 105.802 33.623)" cx="105.8" cy="33.62" rx="1.31" ry="7.27" fill="#4a5058"/>
        <circle cx="64" cy="73.06" r="50.94" fill="#6a7178"/>
        <circle cx="64" cy="73.06" r="40.87" fill="#1c1e22"/>
        <g>
            <path d="M64 43.08c-.81 0-1.47-.66-1.47-1.47v-4.4c0-.81.66-1.47 1.47-1.47c.81 0 1.47.66 1.47 1.47v4.4c0 .82-.66 1.47-1.47 1.47z" fill="#7a7f86"/>
            <path d="M64 110.67c-.81 0-1.47-.66-1.47-1.47v-4.4c0-.81.66-1.47 1.47-1.47c.81 0 1.47.66 1.47 1.47v4.4c0 .81-.66 1.47-1.47 1.47z" fill="#7a7f86"/>
            <path d="M99.99 74.68h-4.4c-.81 0-1.47-.66-1.47-1.47c0-.81.66-1.47 1.47-1.47h4.4c.81 0 1.47.66 1.47 1.47c0 .81-.66 1.47-1.47 1.47z" fill="#7a7f86"/>
            <path d="M32.41 74.68h-4.4c-.81 0-1.47-.66-1.47-1.47c0-.81.66-1.47 1.47-1.47h4.4c.81 0 1.47.66 1.47 1.47c0 .81-.66 1.47-1.47 1.47z" fill="#7a7f86"/>
            <path d="M64 43.08c-.81 0-1.47-.66-1.47-1.47v-4.4c0-.81.66-1.47 1.47-1.47c.81 0 1.47.66 1.47 1.47v4.4c0 .82-.66 1.47-1.47 1.47z" fill="#7a7f86"/>
            <path d="M64 110.67c-.81 0-1.47-.66-1.47-1.47v-4.4c0-.81.66-1.47 1.47-1.47c.81 0 1.47.66 1.47 1.47v4.4c0 .81-.66 1.47-1.47 1.47z" fill="#7a7f86"/>
            <path d="M46.93 46.58l-2.2-3.81c-.41-.7-.17-1.6.54-2.01c.7-.41 1.6-.17 2.01.54l2.2 3.81c.41.7.17 1.6-.54 2.01c-.7.4-1.6.16-2.01-.54z" fill="#7a7f86"/>
        ...
        <path d="M46.93 46.58l-2.2-3.81c-.41-.7-.17-1.6.54-2.01c.7-.41 1.6-.17 2.01.54l2.2 3.81c.41.7.17 1.6-.54 2.01c-.7.4-1.6.16-2.01-.54z" fill="#7a7f86"/>
        <path d="M80.73 105.11l-2.2-3.81c-.41-.7-.16-1.6.54-2.01c.7-.41 1.6-.16 2.01.54l2.2 3.81c.41.7.16 1.6-.54 2.01c-.71.41-1.61.17-2.01-.54z" fill="#7a7f86"/>
        <g>
            <g>
            ...
            <g>
                <path d="M90.09 58.15c-.41-.7-.17-1.6.54-2.01l3.81-2.2c.7-.41 1.6-.16 2.01.54c.41.7.16 1.6-.54 2.01l-3.81 2.2c-.71.4-1.61.16-2.01-.54z" fill="#7a7f86"/>
                <path d="M31.56 91.94c-.41-.7-.16-1.6.54-2.01l3.81-2.2c.7-.41 1.6-.16 2.01.54c.41.7.16 1.6-.54 2.01l-3.81 2.2c-.71.4-1.61.16-2.01-.54z" fill="#7a7f86"/>
            </g>
        </g>
...
<!--        />-->
        <circle cx="64" cy="73.16" r="4.11" fill="#e8c35a"/>
